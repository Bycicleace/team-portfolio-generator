        ...
        return new Promise((resolve, reject) => {
            array.forEach(object => {
                ...
                if (object instanceof Engineer) {
                    this.content += `<i class="fas fa-glasses me-2"></i>`
                } else if (object instanceof Manager) {
                    this.content += `<i class="fas fa-mug-hot me-2"></i>`
                } else if (object instanceof Intern) {
                    this.content += `<i class="fas fa-user-graduate me-2"></i>`
                }
                        
                this.content += `${object.getRole()}</h6>
                    </div>
                ...
                if (object instanceof Engineer) {
                    this.content += `GitHub Username: <a href="https://github.com/${object.getGithub()}" target="_blank">${object.getGithub()}</a>`
                } else if (object instanceof Manager) {
